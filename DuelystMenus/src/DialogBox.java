...
class DialogBox extends VBox {
    ...
    void setButtonMouseEvent(EventHandler<? super MouseEvent> event) {
        getChildren().add(new OrangeButton("SELECT", event));
    }

    void preventClosingOnClick(AtomicBoolean shouldBeClosed) {
